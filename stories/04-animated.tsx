...
const ContainerComponent = React.forwardRef<HTMLDivElement, ContainerComponentProps>(
...
const Modal = React.forwardRef<HTMLDivElement, ContainerComponentProps>(({ children, isClientSide, open }, ref) =>
    isClientSide ? (
        <Transition
